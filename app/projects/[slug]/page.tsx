      ...
      <div className="px-6 pt-20 mx-auto space-y-8 max-w-7xl lg:px-8 md:space-y-16 md:pt-24 lg:pt-32">
        <div className="max-w-2xl mx-auto lg:mx-0">
          <div className="flex items-center space-x-4">
            <Link 
              href="/projects"
              className="group flex items-center hover:text-zinc-200 text-zinc-400 transition-colors"
            >
          ...
          <div className="col-span-2 space-y-8">
            ...
            <div className="prose prose-invert max-w-none">
              <div className="space-y-6">
                ...
                {project.problem && (
                  <div>
                    <h3 className="text-xl font-semibold text-zinc-100">Problem</h3>
                ...
                {project.solution && (
                  <div>
                    <h3 className="text-xl font-semibold text-zinc-100">Solution</h3>
                ...
                {project.results && (
                  <div>
                    <h3 className="text-xl font-semibold text-zinc-100">Results</h3>
                ...
                {project.keyFeatures && project.keyFeatures.length > 0 && (
                  <div>
                    <h3 className="text-xl font-semibold text-zinc-100">Key Features</h3>
                ...
                {project.keyResponsibilities && project.keyResponsibilities.length > 0 && (
                  <div>
                    <h3 className="text-xl font-semibold text-zinc-100">Key Responsibilities</h3>
                    <ul className="list-disc pl-5 space-y-2 text-zinc-300">
                ...
                {project.keyBenefits && project.keyBenefits.length > 0 && (
                  <div>
                    <h3 className="text-xl font-semibold text-zinc-100">Key Benefits</h3>
                    <ul className="list-disc pl-5 space-y-2 text-zinc-300">
                ...
                {project.keyChallenges && project.keyChallenges.length > 0 && (
                  <div>
                    <h3 className="text-xl font-semibold text-zinc-100">Key Challenges</h3>
                    <ul className="list-disc pl-5 space-y-2 text-zinc-300">
                ...
                {project.type === "publication" && (
                  <div>
                    <h3 className="text-xl font-semibold text-zinc-100">Publication Details</h3>
          ...
          <div className="space-y-8">
            ...
            <Card>
              <div className="p-4 md:p-8 space-y-4">
                <h3 className="font-semibold text-zinc-100">Project Links</h3>
                <div className="space-y-2">
                  {project.website && (
                    <a 
                      ...
                      className="flex items-center justify-between p-3 bg-zinc-800 rounded-lg text-zinc-200 hover:bg-zinc-700 transition-colors"
                    >
                  ...
                  {!project.website && !project.googleplay && !project.modelAvailable && !project.doi && (
                    <p className="text-zinc-500 text-sm">No links available for this project.</p>
                  )}
                </div>
              </div>
            </Card>
            ...
            {relatedProjects.length > 0 && (
              <div className="space-y-4">
                <h3 className="font-semibold text-zinc-100">Related Projects</h3>
                <div className="space-y-4">
                      ...
                      <div className="py-2">
                        <Card>
                          <div className="p-4 space-y-2">
                            <h4 className="font-medium text-zinc-100">{relatedProject.title}</h4>
                            <p className="text-sm text-zinc-400 line-clamp-2">{relatedProject.description}</p>
                          </div>
                        </Card>
                      </div>
